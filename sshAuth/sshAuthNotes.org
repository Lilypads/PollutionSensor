...
- there should be a folder with your name, just pop the key in there as a text file, doesn't really massively matter about the format since  i will just coppy this across to the server manually
